...
#define DE_LBRCKT        RALT(N8)
#define DE_RBRCKT        RALT(N9)
#define DE_LBRACE        RALT(N7)
#define DE_RBRACE        RALT(N0)
#define DE_LPAR          STAR
#define DE_RPAR          LPAR
#define DE_BSLASH        RALT(MINUS)
#define DE_FSLASH        AMPERSAND
#define DE_CARET         GRAVE
#define DE_STAR          RIGHT_BRACE
#define DE_HASH          BACKSLASH
#define DE_DOLLAR        DOLLAR
#define DE_PIPE          RALT(LESS_THAN)
#define DE_TILDE         RALT(PLUS)
